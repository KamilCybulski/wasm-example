...
var ASM_CONSTS = [function($0, $1) {appendText($0, $1)}];
...
var real__addItemsToList = asm["addItemsToList"];
asm["addItemsToList"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__addItemsToList.apply(null, arguments);
};
...
var _addItemsToList = Module["_addItemsToList"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["addItemsToList"].apply(null, arguments)
};
